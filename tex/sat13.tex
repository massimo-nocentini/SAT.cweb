...
${}\{{}$\1\6
\&{register} \&{int} \|h${},\39\\{hp},\39\|i,\39\|j,\39\\{jj},\39\|k,\39\\{kk},%
\39\|l,\39\\{ll},\39\\{lll},\39\|p,\39\|q,\39\|r,\39\|s;{}$\6
\&{register} \&{int} \|c${},\39\\{cc},\39\\{endc},\39\\{la},\39\|t,\39\|u,\39%
\|v,\39\|w,\39\|x,\39\|y;{}$\6
\&{register} \&{double} \\{au}${},\39\\{av};{}$\7
...
reports
(default 10000000000). (See \PB{\\{print\_state}}.)
\item{$\bullet$}
...
\&{int} \\{learn\_save}${}\K\T{10000}{}$;\C{ threshold for not outputting to %
\PB{\\{learned\_file}} }\6
...
\\{memk\_max}<\T{2}\V\\{memk\_max}>\T{31}\V\\{trivial\_limit}\Z\T{0}\V(\&{int})%
\,\\{recycle\_inc}<\T{0}\V\\{alpha}<\T{0.0}\V\\{alpha}>\T{1.0}\V\\{rand\_prob}<%
\T{0.0}\V\\{true\_prob}<\T{0.0}\V\\{var\_rho}\Z\T{0.0}\V\\{clause\_rho}\Z%
\T{0.0}){}$\5
${}\{{}$\1\6
...
\\{cells\_prelearned}/(\&{double})\,\\{total\_learned},\39\\{cells\_learned}/(%
\&{double})\,\\{total\_learned});{}$\2\6
...
\1\1\&{void} \\{print\_watches\_for}(\&{int} \|l)\2\2\6
${}\{{}$\1\6
\&{register} \&{uint} \|c;\7
...
\Y\B\4\X31:Subroutines\X${}\mathrel+\E{}$\6
\1\1\&{void} \\{sanity}(\&{int} \\{eptr})\2\2\6
${}\{{}$\1\6
\&{register} \&{uint} \|k${},\39\|l,\39\|c,\39\\{endc},\39\|u,\39\|v,\39%
\\{clauses},\39\\{watches},\39\\{vals},\39\\{llevel};{}$\7
...
\T{4294967296.0}\par
\Y\B\4\X31:Subroutines\X${}\mathrel+\E{}$\6
\1\1\&{void} \\{print\_stats}(\&{void})\2\2\6
${}\{{}$\1\6
\&{register} \&{double} \\{mpc}${}\K\\{mems\_per\_confl},\39\\{ppc}\K\\{props%
\_per\_confl};{}$\7
${}\\{fprintf}(\\{stderr},\39\.{"z="}\|O\.{"d\ d="}\|O\.{".1f\ t="}\|O\.{".1f\
m="}\|O\.{".1f\ p="}\|O\.{".1f\ m/p="}\|O\.{".1f"},\39\\{leveldat}[\T{2}],\39(%
\&{double})\,\\{depth\_per\_decision}/\\{two\_to\_the\_32},\39(\&{double})\,%
\\{trail\_per\_decision}/\\{two\_to\_the\_32},\39\\{mpc}/\\{two\_to\_the\_32},%
\39\\{ppc}/\\{two\_to\_the\_32},\39\\{mpc}/\\{ppc});{}$\6
${}\\{fprintf}(\\{stderr},\39\.{"\ r="}\|O\.{".1f\ L="}\|O\.{".1f\ l="}\|O%
\.{".1f\ g="}\|O\.{".1f\ s="}\|O\.{".2f\ a="}\|O\.{".2f\\n"},\39(\&{double})\,%
\\{res\_per\_confl}/\\{two\_to\_the\_32},\39(\&{double})\,\\{lits\_per\_confl}/%
\\{two\_to\_the\_32},\39(\&{double})\,\\{lits\_per\_nontriv}/\\{two\_to\_the%
\_32},\39(\&{double})\,\\{glucose\_per\_confl}/\\{two\_to\_the\_32},\39(%
\&{double})\,\\{short\_per\_confl}/\\{two\_to\_the\_32},\39(\&{double})\,%
\\{agility}/\\{two\_to\_the\_32});{}$\6
\4${}\}{}$\2\par
\fi
...
${}\\{props}\K\T{0};{}$\6
${}\\{res\_per\_confl}\MRL{+{\K}}{-}(\\{res\_per\_confl}\GG\T{7})+((\&{ullng})%
\,\\{resols}\LL\T{25});{}$\6
...
decision time }\6
\&{ullng} \\{mems\_per\_confl}${},\39\\{lits\_per\_confl},\39\\{lits\_per%
\_nontriv}{}$;\C{ smoothed averages }\6
\&{ullng} \\{res\_per\_confl}${},\39\\{glucose\_per\_confl}{}$;\C{ more
smoothies }\6
...
\Y\B\4\X31:Subroutines\X${}\mathrel+\E{}$\6
\1\1\&{void} \\{print\_state}(\&{int} \\{eptr})\2\2\6
${}\{{}$\1\6
\&{register} \&{uint} \|j${},\39\|k;{}$\7
...
\Y\B\4\X31:Subroutines\X${}\mathrel+\E{}$\6
\1\1\&{void} \\{print\_trail}(\&{int} \\{eptr})\2\2\6
${}\{{}$\1\6
\&{register} \&{int} \|k${},\39\|l;{}$\7
\&{for} ${}(\|k\K\T{0};{}$ ${}\|k<\\{eptr};{}$ ${}\|k\PP){}$\5
${}\{{}$\1\6
...
\Y\B\4\X31:Subroutines\X${}\mathrel+\E{}$\6
\1\1\&{void} \\{print\_unsat}(\&{void})\2\2\6
${}\{{}$\1\6
\&{register} \&{int} \|c${},\39\\{endc},\39\|k,\39\|l;{}$\7
...
\&{uint} \\{wa}${},\39\\{next\_wa}{}$;\C{ a clause in its watch list }\par
\fi
...
\Y\B\4\X31:Subroutines\X${}\mathrel+\E{}$\6
\1\1\&{void} \\{print\_heap}(\&{void})\2\2\6
${}\{{}$\1\6
\&{register} \&{int} \|k;\7
...
${}\|o,\39\\{heap}[\|q]\K\|v;{}$\6
${}\|o,\39\\{vmem}[\|v].\\{activity}\K(\\{vars}-\|q)/(\&{double})\,\\{vars};{}$%
\6
...
$\\{learn}\K{}$(\&{uint} ${}{*})\,\\{malloc}(\\{vars}*\&{sizeof}(\&{uint}));{}$%
\6
\&{if} ${}(\R\\{learn}){}$\5
${}\{{}$\1\6
...
${}\\{conflictdat}\K{}$(\&{int} ${}{*})\,\\{malloc}(\\{vars}*\T{2}*\&{sizeof}(%
\&{int}));{}$\6
\&{if} ${}(\R\\{conflictdat}){}$\5
${}\{{}$\1\6
...
\4${}\}{}$\2\6
${}\\{bytes}\MRL{+{\K}}\\{vars}*\T{2}*\&{sizeof}(\&{int});{}$\6
${}\\{levstamp}\K{}$(\&{uint} ${}{*})\,\\{malloc}(\T{2}*\\{vars}*\&{sizeof}(%
\&{uint}));{}$\6
\&{if} ${}(\R\\{levstamp}){}$\5
${}\{{}$\1\6
...
${}\\{clause\_heap}\K{}$(\&{ullng} ${}{*})\,\\{malloc}(\\{clause\_heap\_size}*%
\&{sizeof}(\&{ullng}));{}$\6
\&{if} ${}(\R\\{clause\_heap}){}$\5
${}\{{}$\1\6
...
as if they were integers. Thus we interpret \PB{\\{activ}(\|c)} as
...
\39\\{mems});{}$\2\6
${}\\{depth\_per\_decision}\MRL{+{\K}}{-}(\\{depth\_per\_decision}\GG\T{7})+((%
\&{ullng})\,\\{llevel}\LL\T{24});{}$\6
${}\\{trail\_per\_decision}\MRL{+{\K}}{-}(\\{trail\_per\_decision}\GG\T{7})+((%
\&{ullng})\,\\{eptr}\LL\T{25});{}$\6
...
\\{minjumplev}} }\6
\&{int} \\{restart\_u}${},\39\\{restart\_v}{}$;\C{ generators for the reluctant
doubling sequence }\6
