...
\&{uint} \\{pos\_start}${},\39\\{neg\_start}{}$;\C{ where the clause lists
start in \PB{\\{tmem}} }\2\6
${}\}{}$ \&{variable};\6
\&{typedef} \&{struct} ${}\{{}$\1\6
...
\1\1\&{void} \\{print\_unsat\_clause}(\&{uint} \|c)\2\2\6
${}\{{}$\1\6
\&{register} \&{uint} \|l${},\39\\{ll};{}$\7
${}\\{fprintf}(\\{stderr},\39\.{"\%d:"},\39\|c){}$;\C{ show the clause number }%
\6
...
\Y\B\4\X26:Subroutines\X${}\mathrel+\E{}$\6
\1\1\&{void} \\{print\_literal\_uses}(\&{uint} \|l)\2\2\6
${}\{{}$\1\6
\&{register} \&{uint} \\{ll}${},\39\|c;{}$\7
${}\\{ll}\K\|l\GG\T{1};{}$\6
...
${}\\{best}\K{}$(\&{uint} ${}{*})\,\\{malloc}(\\{kk}*\&{sizeof}(\&{uint}));{}$\6
\&{if} ${}(\R\\{best}){}$\5
${}\{{}$\1\6
