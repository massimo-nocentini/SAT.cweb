...
\&{uint} \|u${},\39\|v{}$;\C{ a pair of literals }\6
...
\1\1\&{void} \\{print\_timp}(\&{int} \|l)\2\2\6
${}\{{}$\1\6
\&{register} \&{uint} \\{la}${},\39\\{ls};{}$\7
${}\\{printf}(\.{""}\|O\.{"s"}\|O\.{".8s\ ->"},\39\\{litname}(\|l));{}$\6
...
\\{printf}(\.{"\\n"});\6
\4${}\}{}$\2\7
\1\1\&{void} \\{print\_full\_timp}(\&{int} \|l)\2\2\6
${}\{{}$\1\6
...
${}\{{}$\1\6
\&{register} \&{int} \|j${},\39\|k,\39\|l,\39\\{la},\39\\{ls},\39\\{los},\39%
\|p,\39\|q,\39\|u,\39\|v;{}$\7
...
${}\\{tmem}\K{}$(\&{tpair} ${}{*})\,\\{malloc}(\T{3}*\\{ternaries}*\&{sizeof}(%
\&{tpair}));{}$\6
\&{if} ${}(\R\\{tmem}){}$\5
${}\{{}$\1\6
...
$\\{hmem}\K{}$(\&{float} ${}{*})\,\\{malloc}(\\{lits}*(\\{hlevel\_max}+\T{1})*%
\&{sizeof}(\&{float}));{}$\6
\&{if} ${}(\R\\{hmem}){}$\5
${}\{{}$\1\6
...
exceed \PB{\\{max\_score}} (which is 20.0 by default). Furthermore, it computes
...
\Y\B\4\X29:Subroutines\X${}\mathrel+\E{}$\6
\1\1\&{void} \\{hscores}(\&{float} ${}{*}\|h,\39{}$\&{float} ${}{*}\\{hp})\2%
\2{}$\6
${}\{{}$\1\6
\&{register} \&{int} \|j${},\39\|l,\39\\{la},\39\\{ls},\39\|u,\39\|v;{}$\6
\&{register} \&{float} \\{sum}${},\39\\{tsum},\39\\{factor},\39\\{sqfactor},\39%
\\{afactor},\39\\{pos},\39\\{neg};{}$\7
