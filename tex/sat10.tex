...
${}\{{}$\1\6
\&{register} \&{uint} \|h${},\39\|i,\39\|j,\39\|l,\39\|p,\39\|q,\39\|r,\39%
\\{level},\39\\{kk},\39\\{pp},\39\\{qq},\39\\{ll},\39\\{force},\39%
\\{nextmove};{}$\6
\&{register} \&{int} \|c${},\39\\{cc},\39\|k,\39\\{v0},\39\|v,\39\\{vv},\39%
\\{vvv};{}$\7
...
\Y\B\4\X5:Type definitions\X${}\mathrel+\E{}$\6
\&{typedef} \&{struct} ${}\{{}$\1\6
\&{uint} \\{wlist0}${},\39\\{wlist1}{}$;\C{ heads of the watch lists }\6
...
\1\1\&{void} \\{print\_ring}(\&{void})\2\2\6
${}\{{}$\1\6
\&{register} \&{int} \|p;\7
\\{printf}(\.{"Ring:"});\6
\&{if} (\\{active})\5
...
${}\{{}$\1\6
\&{register} \&{int} \|k${},\39\|l,\39\|c,\39\|v;{}$\7
\&{if} (\\{active})\5
${}\{{}$\1\6
...
${}\\{smem}\K{}$(\&{state} ${}{*})\,\\{malloc}((\\{vars}+\T{1})*\&{sizeof}(%
\&{state}));{}$\6
\&{if} ${}(\R\\{smem}){}$\5
${}\{{}$\1\6
