...
${}\{{}$\1\6
\&{register} \&{uint} \|c${},\39\|g,\39\|h,\39\|i,\39\|j,\39\|k,\39\|l,\39\|p,%
\39\|q,\39\|r,\39\\{ii},\39\\{kk},\39\\{ll},\39\\{fcount};{}$\7
...
\1\1\&{void} \\{print\_var}(\&{uint} \|k)\2\2\6
${}\{{}$\1\6
...
${}\\{lmem}\K{}$(\&{literal} ${}{*})\,\\{malloc}((\\{vars}+\\{vars}+\T{1})*%
\&{sizeof}(\&{literal}));{}$\6
\&{if} ${}(\R\\{lmem}){}$\5
${}\{{}$\1\6
...
${}\\{mem}\K{}$(\&{mem\_item} ${}{*})\,\\{malloc}(\\{cells}*\&{sizeof}(\&{mem%
\_item}));{}$\6
\&{if} ${}(\R\\{mem}){}$\5
${}\{{}$\1\6
...
\&{double} \\{acc}${},\39\\{etabar},\39\\{pi0},\39\\{pi1},\39\\{old\_eta},\39%
\\{new\_eta},\39\\{new\_gam},\39\\{factor},\39\\{rein},\39\\{diff}{}$;\C{
intermediate registers for floating-point calculations }\6
...
\Y\B\4\X26:Subroutines\X${}\mathrel+\E{}$\6
\1\1\&{int} \\{fixlist}(\&{register} \&{int} \|k${},\39{}$\&{int} \|b)\2\2\6
${}\{{}$\1\6
\&{register} \&{int} \|c${},\39\|j,\39\|l,\39\\{ll},\39\|p,\39\|q;{}$\7
...
\&{int} \\{bucket}[\T{101}]${},\39\\{unit};{}$\6
\&{int} \\{fixcount}${},\39\\{unitcount};{}$\6
