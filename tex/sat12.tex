...
${}\{{}$\1\6
\&{register} \&{uint} \\{aa}${},\39\|b,\39\|c,\39\\{cc},\39\|h,\39\|i,\39\|j,%
\39\|k,\39\|l,\39\\{ll},\39\|p,\39\\{pp},\39\|q,\39\\{qq},\39\|r,\39\|s,\39\|t,%
\39\|u,\39\\{uu},\39\|v,\39\\{vv},\39\|w,\39\\{ww},\39\|x;{}$\6
...
\.{"llu,\ "}\|O\.{".3f\ of\ "}\|O\.{"llu.\\n"},\39\\{sub\_tries}\?(\&{double})%
\,\\{sub\_false}/(\&{double})\,\\{sub\_tries}:\T{0.0},\39\\{sub\_tries},\39%
\\{str\_tries}\?(\&{double})\,\\{str\_false}/(\&{double})\,\\{str\_tries}:%
\T{0.0},\39\\{str\_tries});{}$\6
\&{if} (\\{elim\_tries})\1\5
...
allowed in \PB{\\{mem}} }\6
\&{uint} \\{sub\_total}${},\39\\{str\_total}{}$;\C{ count of subsumptions,
strengthenings }\6
\&{ullng} \\{sub\_tries}${},\39\\{sub\_false},\39\\{str\_tries},\39\\{str%
\_false}{}$;\C{ stats on those algorithms }\6
...
mems }\6
\&{ullng} \\{elim\_tries}${},\39\\{func\_total}{}$;\C{ stats for elimination }%
\par
\As8, 39\ETs81.
\U3.\fi
...
\&{octa} \\{litinf}${},\39\\{clsinf}{}$;\C{ links within literal and clause
lists }\2\6
...
\1\1\&{void} \\{show\_cell}(\&{uint} \|k)\2\2\6
${}\{{}$\1\6
...
\Y\B\4\X26:Subroutines\X${}\mathrel+\E{}$\6
\1\1\&{void} \\{print\_all}(\&{void})\2\2\6
${}\{{}$\1\6
\&{register} \&{uint} \|c;\7
...
${}\{{}$\1\6
\&{register} \&{uint} \|l${},\39\|k,\39\|c,\39\\{countl},\39\\{countc},\39%
\\{counta},\39\|s;{}$\6
...
$\\{lmem}\K{}$(\&{literal} ${}{*})\,\\{malloc}(\\{lit\_head\_top}*\&{sizeof}(%
\&{literal}));{}$\6
\&{if} ${}(\R\\{lmem}){}$\5
${}\{{}$\1\6
...
\&{uint} \\{alf}${},\39\\{bet}{}$;\C{ loop indices for $\alpha_i$ and $\beta_j$
}\6
...
\&{if} ${}(\\{buckets}<\T{2}){}$\1\5
${}\\{buckets}\K\T{2};{}$\2\6
${}\\{bucket}\K{}$(\&{uint} ${}{*})\,\\{malloc}((\\{buckets}+\T{1})*\&{sizeof}(%
\&{uint}));{}$\6
\&{if} ${}(\R\\{bucket}){}$\5
${}\{{}$\1\6
