...
/*:25*/
#line 78 "knuth/sat0w.w"
;
/*3:*/
#line 100 "knuth/sat0w.w"
...
/*:26*/
#line 79 "knuth/sat0w.w"
;
/*27:*/
#line 510 "knuth/sat0w.w"
...
/*:4*/
#line 83 "knuth/sat0w.w"
    ;
/*8:*/
#line 219 "knuth/sat0w.w"
...
/*:14*/
#line 84 "knuth/sat0w.w"
    ;
/*9:*/
#line 248 "knuth/sat0w.w"
...
#line 285 "knuth/sat0w.w"
        ...
        for (j = k = 0;;)
        {
            ...
            if (buf[j] == '~')
                ...
                i = 0;
/*11:*/
#line 310 "knuth/sat0w.w"

            {
                register tmp_var *p;
                if (cur_tmp_var == bad_tmp_var) /*12:*/
#line 328 "knuth/sat0w.w"
...
/*:12*/
#line 313 "knuth/sat0w.w"
                ;
/*15:*/
#line 361 "knuth/sat0w.w"
...
/*:15*/
#line 315 "knuth/sat0w.w"
                ;
/*16:*/
#line 377 "knuth/sat0w.w"
...
/*:16*/
#line 316 "knuth/sat0w.w"
                ;
                if (p->stamp == clauses || p->stamp == -clauses) /*17:*/
#line 391 "knuth/sat0w.w"
...
#line 296 "knuth/sat0w.w"
        ...
        goto clause_done;
    empty_clause: /*18:*/
#line 401 "knuth/sat0w.w"

        while (k)
        {
/*19:*/
#line 410 "knuth/sat0w.w"
...
/*:18*/
#line 303 "knuth/sat0w.w"
        ;
    clause_done:
        cells += k;

/*:10*/
#line 259 "knuth/sat0w.w"
        ;
    }
    if ((vars >> hbits) >= 10)
    {
...
/*:9*/
#line 85 "knuth/sat0w.w"
    ;
    if (verbose & show_basics)
/*21:*/
#line 428 "knuth/sat0w.w"
...
/*:21*/
#line 87 "knuth/sat0w.w"
    ;
/*30:*/
#line 547 "knuth/sat0w.w"

/*31:*/
#line 558 "knuth/sat0w.w"
...
/*:31*/
#line 548 "knuth/sat0w.w"
    ;
/*32:*/
#line 589 "knuth/sat0w.w"

    for (j = 0; j < nonspec; j++)
        o, cmem[j].start = cmem[j].wlink = 0;
    for (c = nonspec + clauses - 1, k = 0; c >= nonspec; c--)
    {
        j = 0;
/*33:*/
#line 603 "knuth/sat0w.w"
...
/*:33*/
#line 593 "knuth/sat0w.w"
        ;
    }
    o, cmem[c].start = k;

/*:32*/
#line 550 "knuth/sat0w.w"
    ;
/*34:*/
#line 614 "knuth/sat0w.w"

    for (c = vars; c; c--)
    {
/*20:*/
#line 419 "knuth/sat0w.w"
...
/*:20*/
#line 616 "knuth/sat0w.w"
        ;
        o, vmem[c].name.lng = cur_tmp_var->name.lng;
    }

/*:34*/
#line 551 "knuth/sat0w.w"
    ;
/*35:*/
#line 623 "knuth/sat0w.w"
...
/*:35*/
#line 552 "knuth/sat0w.w"
    ;

/*:30*/
#line 88 "knuth/sat0w.w"
    ;
    imems = mems, mems = 0;
/*36:*/
#line 639 "knuth/sat0w.w"
...
#line 680 "knuth/sat0w.w"
    ...
    for (o, c = cmem[level + level + 1 - parity].wlink; c; c = q)
    {
        ...
        {
            o, k = mem[p].litno;
            if (k >= level + level || (o, ((move[k >> 1] ^ k) & 1) == 0))
                break;
        }
        if (p == j)
        {
...
/*:39*/
#line 677 "knuth/sat0w.w"
        ;
    }

/*:36*/
#line 90 "knuth/sat0w.w"
    ;
done:
    if (verbose & show_basics)
