...
/*:29*/
#line 119 "knuth/sat12.w"
;
/*4:*/
#line 164 "knuth/sat12.w"
...
/*:81*/
#line 120 "knuth/sat12.w"
;
/*26:*/
#line 661 "knuth/sat12.w"
...
void print_clause(int c)
{
    ...
    if (is_cls(c) && !is_lit(c))
    {
        ...
        for (k = right(c); !is_cls(k); k = right(k))
        {
            ...
            if (verbose & show_lit_ids)
                fprintf(stderr, "(" O "u)", l);
        }
        fprintf(stderr, "\n");
    }
    else
        fprintf(stderr, "there is no clause " O "d!\n", c);
}

/*:30*/ /*31:*/
#line 767 "knuth/sat12.w"
    ...
    if (is_lit(l) && l >= 2)
    {
        if (vmem[thevar(l)].status)
        {
            fprintf(stderr, " " O "s has been %s!\n", vmem[thevar(l)].name.ch8,
                    vmem[thevar(l)].status == elim_res ? "eliminated" : vmem[thevar(l)].status == elim_quiet ? "quietly eliminated"
                                                                    : vmem[thevar(l)].status == forced_true  ? "forced true"
                                                                    : vmem[thevar(l)].status == forced_false ? "forced false"
                                                                                                             : "clobbered");
            return;
        }
        fprintf(stderr, " " O "s" O ".8s", litname(l));
        ...
        fprintf(stderr, "There is no literal " O "d!\n", l);
}

/*:32*/ /*33:*/
#line 803 "knuth/sat12.w"
...
/*:34*/
#line 808 "knuth/sat12.w"
        ;
    for (c = l, countc = 0; is_cls(c); c++)
        if (size(c)) /*35:*/
#line 847 "knuth/sat12.w"
...
#line 223 "knuth/sat12.w"
    ...
    for (j = argc - 1, k = 0; j; j--)
        ...
        case 's':
            ...
            break;
        case 'e':
            sprintf(erp_file_name, "" O ".99s", argv[j] + 1);
            break;
        case 'm':
            k |= (sscanf(argv[j] + 1, "" O "llu", &mem_max) - 1);
            break;
        case 'c':
            k |= (sscanf(argv[j] + 1, "" O "d", &cutoff) - 1);
            break;
        case 'C':
            k |= (sscanf(argv[j] + 1, "" O "llu", &optimism) - 1);
            break;
        case 'B':
            k |= (sscanf(argv[j] + 1, "" O "d", &buckets) - 1);
            break;
        case 't':
            k |= (sscanf(argv[j] + 1, "" O "d", &maxrounds) - 1);
            break;
        case 'T':
...
/*:5*/
#line 127 "knuth/sat12.w"
    ;
/*9:*/
#line 316 "knuth/sat12.w"
...
/*:15*/
#line 128 "knuth/sat12.w"
    ;
/*10:*/
#line 345 "knuth/sat12.w"
...
#line 382 "knuth/sat12.w"
        ...
        for (j = k = 0;;)
        {
            ...
            if (buf[j] == '~')
                ...
                i = 0;
/*12:*/
#line 407 "knuth/sat12.w"

            {
                register tmp_var *p;
                if (cur_tmp_var == bad_tmp_var) /*13:*/
#line 425 "knuth/sat12.w"
...
/*:13*/
#line 410 "knuth/sat12.w"
                ;
/*16:*/
#line 458 "knuth/sat12.w"
...
/*:16*/
#line 412 "knuth/sat12.w"
                ;
/*17:*/
#line 474 "knuth/sat12.w"
...
/*:17*/
#line 413 "knuth/sat12.w"
                ;
                if (p->stamp == clauses || p->stamp == -clauses) /*18:*/
#line 488 "knuth/sat12.w"
...
#line 393 "knuth/sat12.w"
        ...
        goto clause_done;
    empty_clause: /*19:*/
#line 498 "knuth/sat12.w"

        while (k)
        {
/*20:*/
#line 507 "knuth/sat12.w"
...
/*:19*/
#line 400 "knuth/sat12.w"
        ;
    clause_done:
        cells += k;

/*:11*/
#line 356 "knuth/sat12.w"
        ;
    }
    if ((vars >> hbits) >= 10)
    {
...
/*:10*/
#line 129 "knuth/sat12.w"
    ;
    if (verbose & show_basics)
/*22:*/
#line 525 "knuth/sat12.w"
...
/*:22*/
#line 131 "knuth/sat12.w"
    ;
/*40:*/
#line 951 "knuth/sat12.w"

/*41:*/
#line 965 "knuth/sat12.w"
    ...
    if (xcells + cells > mem_max)
        mem_max = xcells + cells;
    if (mem_max >= 0x100000000)
        mem_max = 0xffffffff;
...
/*:41*/
#line 952 "knuth/sat12.w"
    ;
/*42:*/
#line 985 "knuth/sat12.w"
...
/*:42*/
#line 953 "knuth/sat12.w"
    ;
/*44:*/
#line 1013 "knuth/sat12.w"

    for (c = vars; c; c--)
    {
/*21:*/
#line 516 "knuth/sat12.w"
...
/*:44*/
#line 954 "knuth/sat12.w"
    ;
/*45:*/
#line 1023 "knuth/sat12.w"
...
/*:45*/
#line 955 "knuth/sat12.w"
    ;
/*46:*/
#line 1031 "knuth/sat12.w"

    for (l = 2; is_lit(l); l++)
/*47:*/
#line 1045 "knuth/sat12.w"
...
/*:51*/
#line 1061 "knuth/sat12.w"
            ;
        }
        else /*48:*/
#line 1071 "knuth/sat12.w"
...
/*:48*/
#line 1062 "knuth/sat12.w"
        ;
    }

/*:47*/
#line 1033 "knuth/sat12.w"
    ;
    for (c = l; is_cls(c); c++)
/*49:*/
#line 1083 "knuth/sat12.w"
...
#line 1110 "knuth/sat12.w"

            {
                ...
                if (w & 1)
                {
                    ...
                    else if (vmem[k].status == forced_true)
                        goto unsat;
                }
                else
                {
                    ...
                    else if (vmem[k].status == forced_false)
                        goto unsat;
                }
            }

/*:50*/
#line 1100 "knuth/sat12.w"
            ;
        }
    }

/*:49*/
#line 1035 "knuth/sat12.w"
    ;

/*:46*/
#line 956 "knuth/sat12.w"
    ;
/*52:*/
#line 1148 "knuth/sat12.w"
...
/*:82*/
#line 957 "knuth/sat12.w"
    ;

/*:40*/
#line 132 "knuth/sat12.w"
    ;
    imems = mems, mems = 0;
/*91:*/
#line 1888 "knuth/sat12.w"
...
/*:92*/
#line 1891 "knuth/sat12.w"
    ;
/*65:*/
#line 1437 "knuth/sat12.w"

    {
        register uint c;
/*53:*/
#line 1168 "knuth/sat12.w"
...
/*:56*/
#line 1177 "knuth/sat12.w"
                ;
/*54:*/
#line 1188 "knuth/sat12.w"
...
/*:50*/
#line 1200 "knuth/sat12.w"
                        ;
                    }
/*55:*/
#line 1206 "knuth/sat12.w"
...
/*:55*/
#line 1202 "knuth/sat12.w"
                    ;
                    if (o, slink(c) == 0)
                        o, slink(c) = strengthened, strengthened = c;
                }

/*:54*/
#line 1178 "knuth/sat12.w"
                ;
            }
            vars_gone++;
            if (sanity_checking)
...
/*:59*/
#line 1271 "knuth/sat12.w"
                    ;
                    if (l > ll)
                        sub_false++;
                    else /*60:*/
#line 1308 "knuth/sat12.w"
...
/*:60*/
#line 1273 "knuth/sat12.w"
                    ;
                }

/*:57*/
#line 1446 "knuth/sat12.w"
                ;
/*53:*/
#line 1168 "knuth/sat12.w"
...
/*:53*/
#line 1447 "knuth/sat12.w"
                ;
                if (o, size(c))
                {
                    specialcase = 0;
/*61:*/
#line 1340 "knuth/sat12.w"

                    {
                        ...
                        for (o, vv = v; !is_cls(vv); o, vv = left(vv))
                        {
                            ...
                            o, u = mem[vv].lit;
                            if (specialcase) /*95:*/
#line 1968 "knuth/sat12.w"

                            {
                                if (o, littime(bar(u)) != time)
                                    continue;
                                if (o, newsize(c) >> 2 != size(c) - (littime(u) != time))
                                    continue;
                            }

/*:95*/
#line 1346 "knuth/sat12.w"
                            ;
                            if (verbose & show_subtrials)
                            ...
                            for (o, pp = down(bar(u)); !is_lit(pp); o, pp = down(pp))
                            {
                                str_tries++;
                                o, cc = mem[pp].cls;
                                if (o, ubits & ~clssig(cc))
                                    continue;
                                if (o, size(cc) < s)
                                    continue;
/*62:*/
#line 1363 "knuth/sat12.w"
...
/*:62*/
#line 1356 "knuth/sat12.w"
                                ;
                                if (l > ll)
                                    str_false++;
                                else /*63:*/
#line 1384 "knuth/sat12.w"
...
#line 1401 "knuth/sat12.w"
                                    ...
                                    o, clssig(cc) = ccbits;
/*64:*/
#line 1423 "knuth/sat12.w"

                                    oo, size(cc)--;
                                    if (size(cc) <= 1)
                                    {
                                        if (size(cc) == 0)
                                            confusion("strengthening");
...
/*:50*/
#line 1430 "knuth/sat12.w"
                                        ;
                                    }

/*:64*/
#line 1414 "knuth/sat12.w"
                                    ;
                                    if (o, slink(cc) == 0)
                                        o, slink(cc) = strengthened, strengthened = cc;
                                }

/*:63*/
#line 1358 "knuth/sat12.w"
                                ;
                            }
                        }
                    }
...
/*83:*/
#line 1746 "knuth/sat12.w"

/*84:*/
#line 1759 "knuth/sat12.w"
        ...
        for (x = vars; x; x--)
        {
            if (o, vmem[x].stable)
                continue;
            if (vmem[x].status)
                confusion("touched and eliminated");
            l = pos_lit(x);
            oo, p = occurs(l), q = occurs(l + 1);
            if (p > cutoff && q > cutoff)
                goto reject;
            b = p + q;
            if ((ullng)p * q > b + optimism)
                goto reject;
            if (b > buckets)
                b = buckets;
...
/*:84*/
#line 1747 "knuth/sat12.w"
        ;
        for (b = 2; b <= buckets; b++)
            if (o, bucket[b])
            {
                for (x = bucket[b]; x; o, x = vmem[x].blink)
                    if (o, vmem[x].stable == 0)
                    {
                        if (sanity_checking)
                            sanity();
/*78:*/
#line 1663 "knuth/sat12.w"

                        l = pos_lit(x);
                        oo, clauses_saved = occurs(l) + occurs(l + 1);
                        if ((occurs(l) > cutoff) && (occurs(l + 1) > cutoff))
                            goto elim_done;
                        if ((ullng)occurs(l) * occurs(l + 1) > occurs(l) + occurs(l + 1) + optimism)
                            goto elim_done;
                        elim_tries++;
/*74:*/
#line 1602 "knuth/sat12.w"
...
#line 1633 "knuth/sat12.w"

                                    {
                                        for (o, q = left(p); q != p; o, q = left(q))
                                        {
                                            if (is_cls(q))
                                                continue;
                                            if (oo, lmem[bar(mem[q].lit)].extra != stamp)
                                                break;
                                        }
                                        if (q == p)
                                        {
...
#line 1614 "knuth/sat12.w"
                            ...
                            if (beta0)
                            {
                                stamp++;
/*77:*/
#line 1645 "knuth/sat12.w"

                                if (mem[p].cls != beta0 || mem[p].lit != ll)
                                    confusion("partitioning");
                                for (o, q = left(p); q != p; o, q = left(q))
                                {
                                    if (is_cls(q))
                                        continue;
...
/*:77*/
#line 1619 "knuth/sat12.w"
                                ;
                            }
                        }

/*:74*/
#line 1669 "knuth/sat12.w"
                        ;
                        if (beta0 == 0)
                        {
                            l++;
...
#line 1672 "knuth/sat12.w"
                        ...
                        {
                            if (beta0)
                                fprintf(stderr, " maybe elim " O "s (" O "u," O "d)\n",
                                        vmem[x].name.ch8, beta0, size(beta0) - 1);
                            else
                                fprintf(stderr, " maybe elim " O "s\n", vmem[x].name.ch8);
                        }
                        last_new = 0;
...
#line 1492 "knuth/sat12.w"
                                ...
                                {
                                    if (u == uu) /*72:*/
#line 1539 "knuth/sat12.w"

                                    {
                                        q = p, p = get_cell();
                                        oo, left(q) = p, mem[p].lit = u;
/*69:*/
#line 1519 "knuth/sat12.w"

                                        {
/*67:*/
#line 1505 "knuth/sat12.w"
...
/*:67*/
#line 1521 "knuth/sat12.w"
                                            ;
/*68:*/
#line 1512 "knuth/sat12.w"
...
/*:68*/
#line 1522 "knuth/sat12.w"
                                            ;
                                        }

/*:69*/
#line 1543 "knuth/sat12.w"
                                        ;
                                    }

/*:72*/
#line 1497 "knuth/sat12.w"
...
/*:69*/
#line 1499 "knuth/sat12.w"

                                        else /*73:*/
#line 1546 "knuth/sat12.w"

                                        {
                                            if (p != 1)
                                                o, free_cells(p, left(1));
                                            p = 0;
                                            break;
                                        }

/*:73*/
#line 1500 "knuth/sat12.w"
                                        ;
                                    }
                                    else if (u > uu) /*70:*/
#line 1525 "knuth/sat12.w"
...
/*:67*/
#line 1529 "knuth/sat12.w"
                                        ;
                                    }

/*:70*/
#line 1501 "knuth/sat12.w"

                                    else /*71:*/
#line 1532 "knuth/sat12.w"
...
/*:68*/
#line 1536 "knuth/sat12.w"
                                        ;
                                    }

/*:71*/
#line 1502 "knuth/sat12.w"
                                    ;
                                }

/*:66*/
#line 1688 "knuth/sat12.w"
                                ;
                                if (p)
                                {
                                    o, left(p) = 0;
...
/*:78*/
#line 1751 "knuth/sat12.w"
                        ;
/*85:*/
#line 1775 "knuth/sat12.w"

                        if (verbose & show_details)
                        {
                            fprintf(stderr, "elimination of " O "s", vmem[x].name.ch8);
                            if (beta0)
                                fprintf(stderr, " (" O "u," O "d)", beta0, size(beta0) - 1);
                        ...
                        else
                        {
                            ...
                            for (o, p = down(v); !is_lit(p); o, p = down(p))
                            {
                                for (o, q = right(p); q != p; o, q = right(q))
                                    if (!is_cls(q))
                                        o, fprintf(erp_file, " " O "s" O ".8s", litname(mem[q].lit));
                                fprintf(erp_file, "\n");
                            }
                        }

/*:86*/
#line 1784 "knuth/sat12.w"
                        ;
                        oo, down(last_new) = 0, last_new = down(0);
                        v = pos_lit(x);
/*87:*/
#line 1819 "knuth/sat12.w"
...
/*:50*/
#line 1881 "knuth/sat12.w"
                                    ;
                                }

/*:90*/
#line 1856 "knuth/sat12.w"
                                ;
                                if (verbose & show_resolutions)
                                    print_clause(c);
                                o, newsize(c) = 1;
...
/*:89*/
#line 1824 "knuth/sat12.w"
                            ;
                        }

/*:87*/
#line 1787 "knuth/sat12.w"
                        ;
                        v++;
/*87:*/
#line 1819 "knuth/sat12.w"
...
/*:87*/
#line 1789 "knuth/sat12.w"
                        ;
/*88:*/
#line 1830 "knuth/sat12.w"
...
/*:83*/
#line 1899 "knuth/sat12.w"
            ;
        if (progress == vars_gone || vars_gone == vars)
            break;
/*93:*/
#line 1937 "knuth/sat12.w"
...
/*:65*/
#line 1948 "knuth/sat12.w"
                        ;
                    }
                    else if (newsize(c) & 1)
                        confusion("new clause not all new");
                    if (newsize(c) & 0x3) /*94:*/
#line 1955 "knuth/sat12.w"
...
/*:65*/
#line 1964 "knuth/sat12.w"
                            ;
                        }
                    }

/*:94*/
#line 1950 "knuth/sat12.w"
                    ;
                }
                o, newsize(c) = 0;
            }
...
/*:91*/
#line 134 "knuth/sat12.w"
    ;
finish_up: /*97:*/
#line 1987 "knuth/sat12.w"
    ...
    if (vars_gone == vars)
    {
        if (clauses_gone != clauses)
            confusion("vars gone but not clauses");
        if (verbose & show_basics)
            fprintf(stderr, "No clauses remain.\n");
    }
    else if (clauses_gone == clauses)
        confusion("clauses gone but not vars");
    ...
    {
    unsat:
        fprintf(stderr, "The clauses are unsatisfiable.\n");
    }

/*:97*/
#line 135 "knuth/sat12.w"
    ;
    if (verbose & show_basics)
    {
        fprintf(stderr,
