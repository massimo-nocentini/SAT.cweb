...
/*:5*/
#line 44 "knuth/sat12-erp.w"
;
/*2:*/
#line 62 "knuth/sat12-erp.w"
...
/*:6*/ /*24:*/
#line 434 "knuth/sat12-erp.w"

octa *vmem;
char *lmem;

/*:24*/
#line 45 "knuth/sat12-erp.w"
;
/*29:*/
#line 497 "knuth/sat12-erp.w"
...
/*:29*/
#line 46 "knuth/sat12-erp.w"
;
main(int argc, char *argv[])
{
    register uint c, h, i, j, k, kk, l, p, v, vv;
/*3:*/
#line 84 "knuth/sat12-erp.w"
...
/*:3*/
#line 49 "knuth/sat12-erp.w"
    ;
/*7:*/
#line 170 "knuth/sat12-erp.w"
...
/*:15*/
#line 50 "knuth/sat12-erp.w"
    ;
/*8:*/
#line 199 "knuth/sat12-erp.w"
...
#line 377 "knuth/sat12-erp.w"
        ...
        if (buf[0] == '~')
            ...
            i = j = 0;
/*12:*/
#line 277 "knuth/sat12-erp.w"

        {
            register tmp_var *p;
            if (cur_tmp_var == bad_tmp_var) /*13:*/
#line 297 "knuth/sat12-erp.w"
...
/*:13*/
#line 280 "knuth/sat12-erp.w"
            ;
/*16:*/
#line 330 "knuth/sat12-erp.w"
...
/*:16*/
#line 282 "knuth/sat12-erp.w"
            ;
/*17:*/
#line 349 "knuth/sat12-erp.w"
...
/*:12*/
#line 380 "knuth/sat12-erp.w"
        ;

/*:20*/
#line 204 "knuth/sat12-erp.w"
        ;
        *(cur_cell - 1) = hack_in(*(cur_cell - 1), 4);
        if (!fgets(buf, buf_size, erp_file) || buf[0] != '\n')
            confusion("erp group intro line format");
/*9:*/
#line 211 "knuth/sat12-erp.w"

        for (kk = 0; kk < kkk; kk++)
        {
            if (!fgets(buf, buf_size, erp_file))
                break;
            clauses++;
            if (buf[strlen(buf) - 1] != '\n')
            {
...
/*:9*/
#line 208 "knuth/sat12-erp.w"
        ;
    }

/*:8*/
#line 51 "knuth/sat12-erp.w"
    ;
    if (!clauses)
        fprintf(stderr, "(The erp file is empty!)\n");
/*21:*/
#line 382 "knuth/sat12-erp.w"

    clauses++;
    k = 0;
    while (1)
    {
        if (scanf("" O "10s", buf) != 1)
            break;
        if (buf[0] == '~' && buf[1] == 0)
        {
            printf("~\n");
...
/*:20*/
#line 391 "knuth/sat12-erp.w"
        ;
    }

/*:21*/
#line 53 "knuth/sat12-erp.w"
    ;
/*10:*/
#line 230 "knuth/sat12-erp.w"
...
/*:10*/
#line 54 "knuth/sat12-erp.w"
    ;
/*22:*/
#line 404 "knuth/sat12-erp.w"

/*23:*/
#line 423 "knuth/sat12-erp.w"
...
/*:23*/
#line 405 "knuth/sat12-erp.w"
    ;
    for (l = 2; l < vars + vars + 2; l++)
        lmem[l] = unknown;
/*25:*/
#line 438 "knuth/sat12-erp.w"

    for (c = vars; c; c--)
    {
/*19:*/
#line 368 "knuth/sat12-erp.w"
...
/*:19*/
#line 440 "knuth/sat12-erp.w"
        ;
        vmem[c].lng = cur_tmp_var->name.lng;
    }

/*:25*/
#line 407 "knuth/sat12-erp.w"
    ;
    if (k) /*26:*/
#line 447 "knuth/sat12-erp.w"

    {
        for (i = 0; i < 2;)
        {
/*18:*/
#line 359 "knuth/sat12-erp.w"
...
/*:26*/
#line 408 "knuth/sat12-erp.w"
    ;
/*27:*/
#line 463 "knuth/sat12-erp.w"
...
#line 468 "knuth/sat12-erp.w"
        ...
        else
        {
            ...
            if (v == true)
                ...
                printf(" " O "s" O "s", litname(bar(p)));
            v = true;
        }
    }

/*:27*/
#line 409 "knuth/sat12-erp.w"
    ;
/*28:*/
#line 489 "knuth/sat12-erp.w"
...
/*:28*/
#line 410 "knuth/sat12-erp.w"
    ;
    printf("\n");

/*:22*/
#line 55 "knuth/sat12-erp.w"
    ;
}
