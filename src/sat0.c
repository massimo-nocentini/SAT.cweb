...
/*:25*/
#line 78 "knuth/sat0.w"
;
/*3:*/
#line 100 "knuth/sat0.w"
...
/*:26*/
#line 79 "knuth/sat0.w"
;
/*27:*/
#line 535 "knuth/sat0.w"
...
#line 135 "knuth/sat0.w"
    ...
    for (j = argc - 1, k = 0; j; j--)
        ...
        case 'v':
            ...
            break;
        case 'c':
            k |= (sscanf(argv[j] + 1, "%d", &show_choices_max) - 1);
            break;
        case 'h':
...
/*:4*/
#line 83 "knuth/sat0.w"
    ;
/*8:*/
#line 219 "knuth/sat0.w"
...
/*:14*/
#line 84 "knuth/sat0.w"
    ;
/*9:*/
#line 248 "knuth/sat0.w"
...
#line 285 "knuth/sat0.w"
        ...
        for (j = k = 0;;)
        {
            ...
            if (buf[j] == '~')
                ...
                i = 0;
/*11:*/
#line 310 "knuth/sat0.w"

            {
                register tmp_var *p;
                if (cur_tmp_var == bad_tmp_var) /*12:*/
#line 328 "knuth/sat0.w"
...
/*:12*/
#line 313 "knuth/sat0.w"
                ;
/*15:*/
#line 361 "knuth/sat0.w"
...
/*:15*/
#line 315 "knuth/sat0.w"
                ;
/*16:*/
#line 377 "knuth/sat0.w"
...
/*:16*/
#line 316 "knuth/sat0.w"
                ;
                if (p->stamp == clauses || p->stamp == -clauses) /*17:*/
#line 391 "knuth/sat0.w"
...
#line 296 "knuth/sat0.w"
        ...
        goto clause_done;
    empty_clause: /*18:*/
#line 401 "knuth/sat0.w"

        while (k)
        {
/*19:*/
#line 410 "knuth/sat0.w"
...
/*:18*/
#line 303 "knuth/sat0.w"
        ;
    clause_done:
        cells += k;

/*:10*/
#line 259 "knuth/sat0.w"
        ;
    }
    if ((vars >> hbits) >= 10)
    {
...
/*:9*/
#line 85 "knuth/sat0.w"
    ;
    if (verbose & show_basics)
/*21:*/
#line 428 "knuth/sat0.w"
...
/*:21*/
#line 87 "knuth/sat0.w"
    ;
/*30:*/
#line 572 "knuth/sat0.w"

/*31:*/
#line 583 "knuth/sat0.w"
...
/*:31*/
#line 573 "knuth/sat0.w"
    ;
/*32:*/
#line 614 "knuth/sat0.w"
...
/*:33*/
#line 618 "knuth/sat0.w"
        ;
    }
    active = clauses;
/*34:*/
#line 640 "knuth/sat0.w"
...
/*:34*/
#line 621 "knuth/sat0.w"
    ;
/*35:*/
#line 660 "knuth/sat0.w"
...
/*:36*/
#line 666 "knuth/sat0.w"
            ;
            o, cmem[c].size = i + 1;
        }

/*:35*/
#line 622 "knuth/sat0.w"
        ;

/*:32*/
#line 575 "knuth/sat0.w"
    ;
/*37:*/
#line 686 "knuth/sat0.w"

    for (c = vars; c; c--)
    {
/*20:*/
#line 419 "knuth/sat0.w"
...
/*:20*/
#line 688 "knuth/sat0.w"
        ;
        o, vmem[c].name.lng = cur_tmp_var->name.lng;
    }

/*:37*/
#line 576 "knuth/sat0.w"
    ;
/*38:*/
#line 695 "knuth/sat0.w"
...
/*:38*/
#line 577 "knuth/sat0.w"
    ;

/*:30*/
#line 88 "knuth/sat0.w"
    ;
    imems = mems, mems = 0;
/*39:*/
#line 723 "knuth/sat0.w"
...
newlevel:
    ...
    parity = move[level] & 1;
    if (mem[level + level + 1 - parity].listsize == 0)
        move[level] += 4;
    ...
    if (active == mem[level + level + parity].listsize)
        goto satisfied;
    if (mems > timeout)
    {
...
/*:40*/
#line 747 "knuth/sat0.w"
    ;
/*41:*/
#line 788 "knuth/sat0.w"
...
try_again:
    ...
    if (level > 1) /*42:*/
#line 799 "knuth/sat0.w"

    {
        level--;
/*43:*/
#line 810 "knuth/sat0.w"
...
/*:43*/
#line 802 "knuth/sat0.w"
        ;
/*44:*/
#line 822 "knuth/sat0.w"
...
/*:44*/
#line 803 "knuth/sat0.w"
        ;
        goto try_again;
    }

/*:42*/
#line 760 "knuth/sat0.w"
    ;
    if (1)
    {
        printf("~\n");
...
/*:45*/
#line 766 "knuth/sat0.w"
        ;
    }

/*:39*/
#line 90 "knuth/sat0.w"
    ;
done:
    if (verbose & show_basics)
