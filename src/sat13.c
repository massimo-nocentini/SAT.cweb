...
/*:30*/
#line 100 "knuth/sat13.w"
;
/*4:*/
#line 219 "knuth/sat13.w"
...
/*:140*/
#line 101 "knuth/sat13.w"
;
/*139:*/
#line 3221 "knuth/sat13.w"
...
/*:139*/
#line 102 "knuth/sat13.w"
;
/*31:*/
#line 904 "knuth/sat13.w"
...
/*:35*/
#line 968 "knuth/sat13.w"
    ;
/*36:*/
#line 1032 "knuth/sat13.w"
...
/*:36*/
#line 969 "knuth/sat13.w"
    ;
/*72:*/
#line 1777 "knuth/sat13.w"
...
/*:72*/
#line 970 "knuth/sat13.w"
    ;
/*37:*/
#line 1051 "knuth/sat13.w"
...
/*:37*/
#line 971 "knuth/sat13.w"
    ;
/*38:*/
#line 1096 "knuth/sat13.w"
...
/*:38*/
#line 972 "knuth/sat13.w"
    ;
}

/*:34*/ /*39:*/
#line 1125 "knuth/sat13.w"
...
void print_unsat(void)
{
    ...
    for (c = clause_extra; c < min_learned; c = endc + clause_extra)
    {
        ...
        while (mem[endc].lit & sign_bit)
            endc++;
    }
}

/*:44*/ /*71:*/
#line 1768 "knuth/sat13.w"
...
/*3:*/
#line 212 "knuth/sat13.w"

    for (j = argc - 1, k = 0; j; j--)
        switch (argv[j][0])
        {
/*5:*/
#line 271 "knuth/sat13.w"
        ...
        case 'd':
            ...
            break;
        case 'D':
            k |= (sscanf(argv[j] + 1, "" O "lld", &doomsday) - 1);
            break;
        case 'm':
            k |= (sscanf(argv[j] + 1, "" O "d", &memk_max) - 1);
            break;
        case 't':
            k |= (sscanf(argv[j] + 1, "" O "d", &trivial_limit) - 1);
            break;
        case 'w':
            k |= (sscanf(argv[j] + 1, "" O "d", &warmups) - 1);
            break;
        case 'j':
            k |= (sscanf(argv[j] + 1, "" O "lld", &recycle_bump) - 1);
            break;
        case 'J':
            k |= (sscanf(argv[j] + 1, "" O "lld", &recycle_inc) - 1);
            break;
        case 'K':
            k |= (sscanf(argv[j] + 1, "" O "d", &learn_save) - 1);
            break;
        case 'f':
            k |= (sscanf(argv[j] + 1, "" O "f", &restart_psi_fraction) - 1);
            break;
        case 'a':
            k |= (sscanf(argv[j] + 1, "" O "f", &alpha) - 1);
            break;
        case 'r':
            k |= (sscanf(argv[j] + 1, "" O "f", &var_rho) - 1);
            break;
        case 'R':
            k |= (sscanf(argv[j] + 1, "" O "f", &clause_rho) - 1);
            break;
        case 'p':
            k |= (sscanf(argv[j] + 1, "" O "f", &rand_prob) - 1);
            break;
        case 'P':
            k |= (sscanf(argv[j] + 1, "" O "f", &true_prob) - 1);
            break;
        case 'x':
            ...
            break;
        case 'l':
            learned_name = argv[j] + 1, learned_file = fopen(learned_name, "w");
            if (!learned_file)
                fprintf(stderr, "Sorry, I can't open file `" O "s' for writing!\n",
                        learned_name);
            break;
        case 'L':
            restart_name = argv[j] + 1, restart_file = fopen(restart_name, "w");
            if (!restart_file)
                fprintf(stderr, "Sorry, I can't open file `" O "s' for writing!\n",
                        restart_name);
            break;
        case 'z':
            polarity_in_name = argv[j] + 1,
...
/*:5*/
#line 214 "knuth/sat13.w"
            ;
        default:
            k = 1;
        }
/*6:*/
#line 320 "knuth/sat13.w"
...
/*:6*/
#line 217 "knuth/sat13.w"
    ;

/*:3*/
#line 108 "knuth/sat13.w"
    ;
/*12:*/
#line 435 "knuth/sat13.w"
...
/*:18*/
#line 109 "knuth/sat13.w"
    ;
/*13:*/
#line 464 "knuth/sat13.w"
...
#line 501 "knuth/sat13.w"
        ...
        for (j = k = 0;;)
        {
            ...
            if (buf[j] == '~')
                ...
                i = 0;
/*15:*/
#line 528 "knuth/sat13.w"

            {
                register tmp_var *p;
                if (cur_tmp_var == bad_tmp_var) /*16:*/
#line 546 "knuth/sat13.w"
...
/*:16*/
#line 531 "knuth/sat13.w"
                ;
/*19:*/
#line 579 "knuth/sat13.w"
...
/*:19*/
#line 533 "knuth/sat13.w"
                ;
/*20:*/
#line 595 "knuth/sat13.w"
...
/*:20*/
#line 534 "knuth/sat13.w"
                ;
                if (p->stamp == clauses || p->stamp == -clauses) /*21:*/
#line 609 "knuth/sat13.w"
...
#line 512 "knuth/sat13.w"
        ...
        goto clause_done;
    empty_clause: /*22:*/
#line 619 "knuth/sat13.w"

        while (k)
        {
/*23:*/
#line 628 "knuth/sat13.w"
...
/*:13*/
#line 110 "knuth/sat13.w"
    ;
    if (verbose & show_basics)
/*25:*/
#line 646 "knuth/sat13.w"
...
/*:25*/
#line 112 "knuth/sat13.w"
    ;
/*45:*/
#line 1278 "knuth/sat13.w"

/*46:*/
#line 1289 "knuth/sat13.w"
    ...
    for (k = 1; k <= vars; k++)
        o, vmem[k].value = unset, vmem[k].tloc = -1;
...
/*:46*/
#line 1279 "knuth/sat13.w"
    ;
    if (polarity_infile) /*79:*/
#line 1921 "knuth/sat13.w"

    {
        if (true_prob >= 1.0)
            true_prob_thresh = 0x80000000;
        else
            true_prob_thresh = (int)(true_prob * 2147483648.0);
        for (q = 0;;)
        {
            register tmp_var *p;
            if (fscanf(polarity_infile, "" O "s", buf) != 1)
                break;
            if (buf[0] == '~')
                i = j = 1;
            else
...
/*:79*/
#line 1280 "knuth/sat13.w"

    else /*78:*/
#line 1892 "knuth/sat13.w"
...
/*:78*/
#line 1281 "knuth/sat13.w"
    ;
/*47:*/
#line 1304 "knuth/sat13.w"

    free(buf);
    free(hash);
/*48:*/
#line 1343 "knuth/sat13.w"

    {
        ullng proto_memsize = (clauses - unaries - binaries) * clause_extra + (cells - unaries - 2 * binaries) + clause_extra;
...
/*:56*/
#line 1282 "knuth/sat13.w"
    ;
/*49:*/
#line 1371 "knuth/sat13.w"
...
/*:50*/
#line 1377 "knuth/sat13.w"
        ;
        if (k <= 2) /*51:*/
#line 1417 "knuth/sat13.w"

        {
            if (k < 2) /*52:*/
#line 1431 "knuth/sat13.w"
...
/*:53*/
#line 1400 "knuth/sat13.w"
    ;

/*:49*/
#line 1284 "knuth/sat13.w"
    ;
/*54:*/
#line 1452 "knuth/sat13.w"

    for (c = vars; c; c--)
    {
/*24:*/
#line 637 "knuth/sat13.w"
...
/*:54*/
#line 1285 "knuth/sat13.w"
    ;
/*55:*/
#line 1462 "knuth/sat13.w"
...
/*:55*/
#line 1286 "knuth/sat13.w"
    ;
/*57:*/
#line 1492 "knuth/sat13.w"
...
#line 2620 "knuth/sat13.w"
    ...
    for (k = 0; k + k < buckets; k++)
        o, rangedist[k + k] = rangedist[k + k + 1] = 0;

/*:109*/ /*116:*/
#line 2760 "knuth/sat13.w"
...
/*:116*/
#line 1287 "knuth/sat13.w"
    ;

/*:45*/
#line 113 "knuth/sat13.w"
    ;
    imems = mems, mems = 0;
/*124:*/
#line 2875 "knuth/sat13.w"

/*130:*/
#line 3011 "knuth/sat13.w"

    if (rand_prob >= 1.0)
        rand_prob_thresh = 0x80000000;
    else
        rand_prob_thresh = (int)(rand_prob * 2147483648.0);
    var_bump_factor = 1.0 / (double)var_rho;
    clause_bump_factor = 1.0 / clause_rho;
    show_choices_max <<= 1;
    next_recycle = recycle_bump;
    if (next_recycle > doomsday)
        next_recycle = doomsday;
    ...
    for (k = 0; k < vars; k++)
        o, leveldat[k + k] = -1, leveldat[k + k + 1] = 0;

/*:130*/
#line 2876 "knuth/sat13.w"
    ;
square_one:
    llevel = warmup_cycles = 0;
    if (sanity_checking)
        sanity(eptr);
    if (verbose & show_initial_clauses)
        print_unsat();
    lptr = 0;
startup:
    conflict_level = 0;
...
#line 1521 "knuth/sat13.w"
                        ...
                        else
                        {
                            ...
                            agility -= agility >> 13;
                            if (o, (vmem[thevar(ll)].oldval + ll) & 1)
                                agility += 1 << 19;
                        }
                    }
                    while (1)
...
/*:58*/
#line 2976 "knuth/sat13.w"
                ;
            }
        }
/*60:*/
#line 1568 "knuth/sat13.w"
        ...
        if (wa)
        {
            for (q = 0; wa; wa = next_wa)
            {
                ...
                if (ll == bar(lt))
                {
                    ...
                    o, next_wa = link1(wa);
/*63:*/
#line 1626 "knuth/sat13.w"

                if ((o, isknown(ll)) && !iscontrary(ll))
                {
/*64:*/
#line 1637 "knuth/sat13.w"

                    if (q == 0)
                        o, lmem[bar(lt)].watch = wa;
                    else
                        o, link1(q) = wa;
                    q = wa;

/*:64*/
#line 1628 "knuth/sat13.w"
                    ;
                    continue;
                }

/*:63*/
#line 1580 "knuth/sat13.w"
                ;
                for (o, s = size(wa), j = wa + s - 1; j > wa + 1; j--)
                {
                    o, l = mem[j].lit;
                    if (o, !isknown(l) || !iscontrary(l))
                        break;
                    if (vmem[thevar(l)].value < 2 && llevel)
/*61:*/
#line 1600 "knuth/sat13.w"

                    {
                        o, size(wa) = --s;
                        if (j != wa + s)
                            oo, mem[j].lit = mem[wa + s].lit;
                        o, mem[wa + s].lit = l + sign_bit;
                    }

/*:61*/
#line 1585 "knuth/sat13.w"
                    ;
                }
                if (j > wa + 1) /*62:*/
#line 1607 "knuth/sat13.w"
...
/*:64*/
#line 1588 "knuth/sat13.w"
                ;
/*65:*/
#line 1649 "knuth/sat13.w"

                props++;
                if (isknown(ll)) /*67:*/
#line 1685 "knuth/sat13.w"
...
/*:58*/
#line 1664 "knuth/sat13.w"
                        ;
                    }
                }

/*:65*/
#line 1589 "knuth/sat13.w"
                ;
            }
/*64:*/
#line 1637 "knuth/sat13.w"
...
/*:64*/
#line 1591 "knuth/sat13.w"
            ;
        }

/*:60*/
#line 2979 "knuth/sat13.w"
        ;
    }

/*:127*/
#line 2884 "knuth/sat13.w"
    ;
newlevel:
    if (sanity_checking)
        sanity(eptr);
    if (delta && (mems >= thresh))
        thresh += delta, print_state(eptr);
    if (mems >= timeout)
    {
...
#line 2698 "knuth/sat13.w"
            ...
            for (h = 0, c = first_learned; c < max_learned; h++, c = endc + learned_extra)
            {
                o, endc = c + size(c);
/*110:*/
#line 2634 "knuth/sat13.w"

                {
                    o, l = mem[c].lit;
                    if (o, lmem[l].reason == c)
                    {
                        if (o, vmem[thevar(l)].value & -2)
                            o, range(c) = 0, asserts++;
                        else
                            goto its_true;
                    }
...
/*:110*/
#line 2705 "knuth/sat13.w"
                ;
                while (o, mem[endc].lit & sign_bit)
                    endc++;
            }
            budget = h / 2;
            prev_learned = 0;
...
#line 1817 "knuth/sat13.w"

                    {
                        o, av = vmem[v].activity;
                        h = hn++, j = 0;
                        if (h > 0) /*73:*/
#line 1797 "knuth/sat13.w"
...
/*:73*/
#line 1821 "knuth/sat13.w"
                        ;
                        if (j == 0)
                            oo, heap[h] = v, vmem[v].hloc = h;
                    }

/*:74*/
#line 2990 "knuth/sat13.w"
                    ;
                }
                lptr = eptr;
                if (sanity_checking)
                {
                    while (llevel > jumplev)
                        leveldat[llevel] = -1, llevel -= 2;
                }
                else
                    llevel = jumplev;
            }
...
/*:128*/
#line 3086 "knuth/sat13.w"
            ;
            o, c = leveldat[llevel + 1];
            if (c < 0)
                o, l = -c, ll = conflictdat[llevel + 1];
            goto prep_clause;
        store_clause:
            ...
            else
            {
                ...
                {
                    if (jumplev < minjumplev)
                        minjumplev = jumplev, next_learned = 0;
                ...
                {
/*103:*/
#line 2450 "knuth/sat13.w"

                    {
/*104:*/
#line 2468 "knuth/sat13.w"
...
/*:106*/
#line 2512 "knuth/sat13.w"
                                    ;
                                }
                            }

/*:105*/
#line 2474 "knuth/sat13.w"
                            ;
                        }
                        c = max_learned;
...
/*:104*/
#line 2452 "knuth/sat13.w"
                        ;
/*107:*/
#line 2527 "knuth/sat13.w"
...
/*:107*/
#line 2453 "knuth/sat13.w"
                            ;
                        prev_learned = c;
                        if (learned_file && learned_size <= learn_save)
/*108:*/
#line 2556 "knuth/sat13.w"
...
/*:108*/
#line 2456 "knuth/sat13.w"
                        ;
                    }

/*:103*/
#line 3112 "knuth/sat13.w"
                    ;
...
/*:128*/
#line 3064 "knuth/sat13.w"
        ;
        trail_marker = eptr;
        if (jumplev == minjumplev)
/*135:*/
#line 3120 "knuth/sat13.w"
                ...
                if (verbose & (show_details + show_choices))
                {
                    if ((verbose & show_details) || llevel <= show_choices_max)
                    {
                        if (c)
                            ...
                            fprintf(stderr, "level 0, " O "s" O ".8s\n", litname(lll));
                    }
                }
...
/*:135*/
#line 3067 "knuth/sat13.w"
            ;
/*82:*/
#line 1972 "knuth/sat13.w"

        var_bump *= var_bump_factor;
        clause_bump *= clause_bump_factor;

/*:82*/
#line 3068 "knuth/sat13.w"
        ;
        if (recycle_point)
        {
/*113:*/
#line 2711 "knuth/sat13.w"

/*114:*/
#line 2716 "knuth/sat13.w"

            for (o, j = minrange, s = asserts + rangedist[j]; s < budget && j < maxrange;)
                o, s += rangedist[++j];
            if (s > budget) /*115:*/
#line 2749 "knuth/sat13.w"

            {
                register ullng accum;
                t = s - budget;
                jj = rangedist[j] - t;
                if (jj > clause_heap_size)
                    jj = clause_heap_size;
/*117:*/
#line 2778 "knuth/sat13.w"

                for (h = 0, c = first_learned; h < jj; c = endc + learned_extra)
                {
                    if (c >= recycle_point)
                        confusion("rangedist1");
                    o, endc = c + size(c);
                    while (o, mem[endc].lit & sign_bit)
                        endc++;
                    if (o, range(c) == j)
                        clause_heap[h++] = activ_as_lit(c) + c;
                }

/*:117*/
#line 2755 "knuth/sat13.w"
                ;
/*118:*/
#line 2786 "knuth/sat13.w"

                for (h = jj >> 1; h;)
                {
                    q = h + h, p = --h, o, accum = clause_heap[p];
/*119:*/
#line 2794 "knuth/sat13.w"

                    while (q <= jj)
                    {
                        if (q == jj || (oo, clause_heap[q - 1] < clause_heap[q]))
                            q--;
                        if (accum <= clause_heap[q])
                            break;
...
/*:119*/
#line 2789 "knuth/sat13.w"
                    ;
                }

/*:118*/
#line 2756 "knuth/sat13.w"
                ;
/*120:*/
#line 2806 "knuth/sat13.w"

                for (;; c = endc + learned_extra)
                {
                    if (c >= recycle_point)
                        confusion("rangedist2");
                    if (o, range(c) == j)
                    {
...
/*:120*/
#line 2757 "knuth/sat13.w"
                ;
            }

/*:115*/
#line 2719 "knuth/sat13.w"
            ;
            ...
            for (h = 0, cc = c = first_learned; c < max_learned; c = endc + learned_extra)
            {
                ...
                while (o, mem[endc].lit & sign_bit)
                    o, mem[endc++].lit = 0;
                if (c < recycle_point && (o, range(c) > j))
                    continue;
...
/*:114*/
#line 2712 "knuth/sat13.w"
            ;
/*122:*/
#line 2848 "knuth/sat13.w"
...
/*:123*/
#line 2857 "knuth/sat13.w"
                ;
            }

/*:122*/
#line 2713 "knuth/sat13.w"
            ;
            recycle_point = 0;

/*:113*/
#line 3070 "knuth/sat13.w"
            ;
            if (sanity_checking)
                sanity(eptr);
/*132:*/
#line 3034 "knuth/sat13.w"
...
/*:132*/
#line 3072 "knuth/sat13.w"
            ;
        }

/*:133*/
#line 2892 "knuth/sat13.w"
        ;
        goto startup;
    }
    if (!conflict_level)
...
/*:138*/
#line 2896 "knuth/sat13.w"
        ;
        if (total_learned >= next_recycle)
            full_run = 1;
        else if (total_learned >= next_restart) /*136:*/
#line 3142 "knuth/sat13.w"

        {
/*131:*/
#line 3027 "knuth/sat13.w"

            if ((restart_u & -restart_u) == restart_v)
                restart_u++, restart_v = 1, restart_thresh = restart_psi;
            else
                restart_v <<= 1, restart_thresh += restart_thresh >> 4;
            next_restart = total_learned + restart_v;
            if (next_restart > doomsday)
                next_restart = doomsday;

/*:131*/
#line 3144 "knuth/sat13.w"
            ;
            if (agility <= restart_thresh) /*137:*/
#line 3161 "knuth/sat13.w"
...
/*:136*/
#line 2898 "knuth/sat13.w"
        ;
    }
    llevel += 2;
/*75:*/
#line 1842 "knuth/sat13.w"
...
launch:
    ...
    goto proceed;
/*125:*/
#line 2923 "knuth/sat13.w"

confl:
    if (llevel)
    {
    prep_clause: /*86:*/
#line 2064 "knuth/sat13.w"

        oldptr = jumplev = xnew = clevels = resols = 0;
/*91:*/
#line 2135 "knuth/sat13.w"

        if (curstamp >= 0xfffffffe)
        {
            for (k = 1; k <= vars; k++)
                oo, vmem[k].stamp = levstamp[k + k - 2] = 0;
            curstamp = 1;
        }
        else
            curstamp += 3;
...
/*:91*/
#line 2066 "knuth/sat13.w"
        ;
        if (verbose & show_gory_details)
            fprintf(stderr, "Preparing to learn");
        if (c < 0) /*88:*/
#line 2098 "knuth/sat13.w"
...
/*:73*/
#line 1761 "knuth/sat13.w"
            ;

/*:70*/
#line 2103 "knuth/sat13.w"
            ;
            l = -c;
            if (o, vmem[thevar(l)].tloc > tl)
                tl = vmem[thevar(l)].tloc;
            o, vmem[thevar(l)].stamp = curstamp;
/*70:*/
#line 1755 "knuth/sat13.w"
...
/*:70*/
#line 2107 "knuth/sat13.w"
            ;
            xnew = 1;
        }

/*:88*/
#line 2069 "knuth/sat13.w"

        else /*87:*/
#line 2080 "knuth/sat13.w"
...
/*:70*/
#line 2085 "knuth/sat13.w"
            ;
            if (c >= first_learned) /*81:*/
#line 1964 "knuth/sat13.w"
...
/*:84*/
#line 1969 "knuth/sat13.w"
                ;
            }

/*:81*/
#line 2086 "knuth/sat13.w"
            ;
            for (o, s = size(c), k = c + s - 1; k > c; k--)
            {
                ...
                if (j > tl)
                    tl = j;
/*95:*/
#line 2183 "knuth/sat13.w"

                {
                    o, jj = vmem[thevar(l)].value & -2;
                    if (!jj)
                        confusion("permanently false lit");
                    else
                    {
                        o, vmem[thevar(l)].stamp = curstamp;
/*70:*/
...
#line 2189 "knuth/sat13.w"
                        ...
                        else
                        {
                            ...
                            if (o, levstamp[jj] < curstamp)
                                o, levstamp[jj] = curstamp, clevels++;
                            else if (levstamp[jj] == curstamp)
                                o, levstamp[jj] = curstamp + 1;
                        }
                    }
                }

/*:95*/
#line 2091 "knuth/sat13.w"
                ;
            }
        }

/*:87*/
#line 2070 "knuth/sat13.w"
        ;
/*92:*/
#line 2141 "knuth/sat13.w"
...
/*:95*/
#line 2180 "knuth/sat13.w"
                ;
            }

/*:94*/
#line 2164 "knuth/sat13.w"
...
/*:95*/
#line 2170 "knuth/sat13.w"
                    ;
                }
                if (xnew + oldptr + 1 < s && xnew)
/*98:*/
#line 2260 "knuth/sat13.w"
...
/*:98*/
#line 2173 "knuth/sat13.w"
                ;
            }

/*:93*/
#line 2148 "knuth/sat13.w"
            ;
        }

/*:92*/
#line 2071 "knuth/sat13.w"
        ;
        while (1)
        {
            o, l = trail[tl--];
...
/*:86*/
#line 2925 "knuth/sat13.w"
        ;
/*102:*/
#line 2414 "knuth/sat13.w"
...
#line 2342 "knuth/sat13.w"
        ...
        is_red:
            o, vmem[thevar(ll)].stamp = curstamp + 1;
...
/*:101*/
#line 2384 "knuth/sat13.w"
            ;

/*:100*/
#line 2421 "knuth/sat13.w"
            ;
            continue;
        redundant:
            learned_size--;
        ...
        if (learned_size <= (jumplev >> 1) + trivial_limit)
            trivial_learning = 0;
        else
            trivial_learning = 1, clevels = jumplev >> 1, learned_size = clevels + 1, trivials++;
        cells_learned += learned_size, total_learned++;
/*40:*/
#line 1152 "knuth/sat13.w"
...
/*:40*/
#line 2430 "knuth/sat13.w"
        ;

/*:102*/
#line 2926 "knuth/sat13.w"
        ;
...
/*:129*/
#line 2954 "knuth/sat13.w"
        ;
    }

/*:125*/
#line 2916 "knuth/sat13.w"
    ;

/*:124*/
#line 115 "knuth/sat13.w"
    ;
all_done: /*8:*/
#line 359 "knuth/sat13.w"
    ...
    if (restart_file)
        fclose(restart_file);
    if (polarity_infile)
        fclose(polarity_infile);
    if (polarity_outfile)
        fclose(polarity_outfile);

/*:8*/
#line 116 "knuth/sat13.w"
    ;
/*7:*/
#line 332 "knuth/sat13.w"
