...
/*:24*/
#line 73 "knuth/sat8.w"
;
/*4:*/
#line 97 "knuth/sat8.w"
...
/*:25*/
#line 74 "knuth/sat8.w"
;
/*26:*/
#line 524 "knuth/sat8.w"
...
#line 145 "knuth/sat8.w"
    ...
    for (j = argc - 1, k = 0; j; j--)
        ...
        case 'd':
            ...
            break;
        case 't':
            k |= (sscanf(argv[j] + 1, "%llu", &maxsteps) - 1);
            break;
        case 'c':
            k |= (sscanf(argv[j] + 1, "%u", &maxthresh) - 1);
            break;
        case 'w':
            k |= (sscanf(argv[j] + 1, "%d", &maxtrials) - 1);
            break;
        case 'p':
            k |= (sscanf(argv[j] + 1, "%lf", &nongreedprob) - 1);
            break;
        case 'T':
...
/*:5*/
#line 78 "knuth/sat8.w"
    ;
/*9:*/
#line 237 "knuth/sat8.w"
...
/*:15*/
#line 79 "knuth/sat8.w"
    ;
/*10:*/
#line 266 "knuth/sat8.w"
...
#line 303 "knuth/sat8.w"
        ...
        for (j = k = 0;;)
        {
            ...
            if (buf[j] == '~')
                ...
                i = 0;
/*12:*/
#line 328 "knuth/sat8.w"

            {
                register tmp_var *p;
                if (cur_tmp_var == bad_tmp_var) /*13:*/
#line 346 "knuth/sat8.w"
...
/*:13*/
#line 331 "knuth/sat8.w"
                ;
/*16:*/
#line 379 "knuth/sat8.w"
...
/*:16*/
#line 333 "knuth/sat8.w"
                ;
/*17:*/
#line 395 "knuth/sat8.w"
...
/*:17*/
#line 334 "knuth/sat8.w"
                ;
                if (p->stamp == clauses || p->stamp == -clauses) /*18:*/
#line 409 "knuth/sat8.w"
...
#line 314 "knuth/sat8.w"
        ...
        goto clause_done;
    empty_clause: /*19:*/
#line 419 "knuth/sat8.w"

        while (k)
        {
/*20:*/
#line 428 "knuth/sat8.w"
...
/*:19*/
#line 321 "knuth/sat8.w"
        ;
    clause_done:
        cells += k;

/*:11*/
#line 277 "knuth/sat8.w"
        ;
    }
    if ((vars >> hbits) >= 10)
    {
...
/*:10*/
#line 80 "knuth/sat8.w"
    ;
    if (verbose & show_basics)
/*22:*/
#line 449 "knuth/sat8.w"
...
/*:22*/
#line 82 "knuth/sat8.w"
    ;
/*29:*/
#line 568 "knuth/sat8.w"

/*30:*/
#line 577 "knuth/sat8.w"
...
/*:30*/
#line 569 "knuth/sat8.w"
    ;
/*31:*/
#line 610 "knuth/sat8.w"

    for (c = vars; c; c--)
        o, vmem[c - 1].pos_start = vmem[c - 1].neg_start = 0;

/*:31*/
#line 570 "knuth/sat8.w"
    ;
/*32:*/
#line 613 "knuth/sat8.w"

    for (c = clauses, cur_mcell = mem + cells, kk = 0; c; c--)
    {
        o, cmem[c].start = cur_mcell - mem, k = 0;
/*33:*/
#line 637 "knuth/sat8.w"
...
#line 639 "knuth/sat8.w"
            ...
            if (l & 1)
                oo, vmem[l >> 1].neg_start++;
            else
                oo, vmem[l >> 1].pos_start++;
        }

/*:33*/
#line 616 "knuth/sat8.w"
        ;
        if (k > kk)
            kk = k;
    }
...
/*:32*/
#line 572 "knuth/sat8.w"
    ;
/*35:*/
#line 662 "knuth/sat8.w"

    for (c = vars; c; c--)
    {
/*21:*/
#line 440 "knuth/sat8.w"
...
/*:21*/
#line 664 "knuth/sat8.w"
        ;
        o, nmem[c - 1].lng = cur_tmp_var->name.lng;
    }

/*:35*/
#line 573 "knuth/sat8.w"
    ;
/*34:*/
#line 648 "knuth/sat8.w"
    ...
    {
        if (k == kk)
            o, c++, kk = cmem[c + 1].start;
        l = mem[k];
        if (l & 1)
            ooo, i = vmem[l >> 1].neg_start - 1, tmem[i] = c, vmem[l >> 1].neg_start = i;
        else
            ooo, i = vmem[l >> 1].pos_start - 1, tmem[i] = c, vmem[l >> 1].pos_start = i;
    }

/*:34*/
#line 574 "knuth/sat8.w"
    ;
/*36:*/
#line 671 "knuth/sat8.w"
...
/*:36*/
#line 575 "knuth/sat8.w"
    ;

/*:29*/
#line 83 "knuth/sat8.w"
    ;
    imems = mems, mems = 0;
/*37:*/
#line 683 "knuth/sat8.w"

    if (maxsteps == 0)
        maxsteps = maxthresh * vars;
...
/*38:*/
#line 715 "knuth/sat8.w"

        for (k = 0, r = 1; k < vars; k++)
        {
            if (r == 1)
                mems += 4, r = gb_next_rand() + (1U << 31);
            o, vmem[k].val = r & 1, r >>= 1;
            vmem[k].breakcount = 0;
        }

/*:38*/
#line 692 "knuth/sat8.w"
        ;
        if (verbose & show_details) /*47:*/
#line 839 "knuth/sat8.w"
...
/*:47*/
#line 693 "knuth/sat8.w"
        ;
/*39:*/
#line 722 "knuth/sat8.w"
        ...
        for (c = k = 0; c < clauses; c++)
        {
            ...
            {
                if (p)
                    oo, vmem[ll >> 1].breakcount++;
                else
                    oo, cmem[c].fplace = fcount, cmem[fcount++].fslot = c;
            }
        }

/*:39*/
#line 694 "knuth/sat8.w"
        ;
        for (step = 0;; step++)
        {
            if (fcount == 0) /*48:*/
#line 847 "knuth/sat8.w"
...
/*:40*/
#line 702 "knuth/sat8.w"
            ;
/*41:*/
#line 747 "knuth/sat8.w"
...
/*:41*/
#line 703 "knuth/sat8.w"
            ;
/*42:*/
#line 775 "knuth/sat8.w"

            if (l & 1)
            {
                oo, k = vmem[p].neg_start, kk = vmem[p + 1].pos_start;
/*43:*/
#line 790 "knuth/sat8.w"
...
#line 829 "knuth/sat8.w"

                        {
                            ...
                            o, vmem[q >> 1].breakcount++;
                            if (i != ii)
                                oo, mem[i] = mem[ii], mem[ii] = q;
                        }

/*:46*/
#line 807 "knuth/sat8.w"
...
/*:44*/
#line 787 "knuth/sat8.w"
                ;
            }

/*:42*/
#line 704 "knuth/sat8.w"
            ;
        }
    }
    printf("~?\n");
    if (verbose & show_basics)
        fprintf(stderr, "DUNNO\n");
    trial--;
done:

/*:37*/
#line 85 "knuth/sat8.w"
    ;
    if (verbose & show_basics)
        fprintf(stderr,
