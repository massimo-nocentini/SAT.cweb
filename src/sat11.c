...
#line 237 "knuth/sat11.w"
    ...
    for (j = argc - 1, k = 0; j; j--)
        ...
        case 'a':
            ...
            break;
        case 't':
            k |= (sscanf(argv[j] + 1, "" O "f", &max_score) - 1);
            break;
        case 'l':
            k |= (sscanf(argv[j] + 1, "" O "d", &hlevel_max) - 1);
            break;
        case 'p':
...
#line 945 "knuth/sat11.w"
    ;
/*40:*/
#line 1046 "knuth/sat11.w"

    forcedlits = 0;
    for (l = 2; l < badlit; l++)
        o, timp[l].addr = timp[l].size = 0;
...
#line 1063 "knuth/sat11.w"
        ...
        {
            for (jj = 0; jj < j; jj++)
                fprintf(out_file, " " O "s" O ".8s", litname(rstack[jj]));
            fprintf(out_file, "\n");
        }
        if (j == 1) /*42:*/
#line 1084 "knuth/sat11.w"
...
/*:43*/
#line 1076 "knuth/sat11.w"

        else /*44:*/
#line 1113 "knuth/sat11.w"
...
/*:44*/
#line 1077 "knuth/sat11.w"
        ;

/*:41*/
#line 1050 "knuth/sat11.w"
        ;
    }
/*45:*/
#line 1122 "knuth/sat11.w"
...
#line 2009 "knuth/sat11.w"
    ...
    if (freevars == 0)
        goto satisfied;
/*96:*/
#line 2192 "knuth/sat11.w"

/*95:*/
#line 2151 "knuth/sat11.w"
    ...
    {
        if (level > hmem_alloc_level)
            hmem_alloc_level++, bytes += lits * sizeof(float);
        hscores(htable(level - 1), htable(level));
        heur = htable(level);
    }
    else
    {
        if (hlevel_max > hmem_alloc_level)
            hmem_alloc_level++, bytes += lits * sizeof(float);
...
/*:124*/
#line 3031 "knuth/sat11.w"
                                        ;
                                    }
                                }
                                else
                                    weighted_new_binaries += heur[u] * heur[v];
                            }

/*:134*/
#line 3010 "knuth/sat11.w"
                            ;
                        }
