...
/*:26*/
#line 82 "knuth/sat10.w"
;
/*3:*/
#line 107 "knuth/sat10.w"
...
/*:27*/
#line 83 "knuth/sat10.w"
;
/*28:*/
#line 594 "knuth/sat10.w"
...
void print_state(int l)
{
    ...
    for (k = 1; k <= l; k++)
        fprintf(stderr, "" O "c", smem[k].move + '0');
    fprintf(stderr, "\n");
    fflush(stderr);
}

/*:32*/
#line 84 "knuth/sat10.w"
;
...
#line 161 "knuth/sat10.w"
    ...
    for (j = argc - 1, k = 0; j; j--)
        ...
        case 'V':
            ...
            break;
        case 'T':
            k |= (sscanf(argv[j] + 1, "%lld", &timeout) - 1);
            break;
        default:
            k = 1;
        }
...
/*:4*/
#line 88 "knuth/sat10.w"
    ;
/*8:*/
#line 256 "knuth/sat10.w"
...
/*:15*/
#line 89 "knuth/sat10.w"
    ;
/*9:*/
#line 285 "knuth/sat10.w"

    if (primary_file) /*10:*/
#line 330 "knuth/sat10.w"
...
#line 351 "knuth/sat10.w"
            ...
            for (j = k = non_clause = 0; !non_clause;)
            {
                ...
                if (buf[j] == '~')
                    ...
                    i = 0;
/*12:*/
#line 375 "knuth/sat10.w"

                {
                    register tmp_var *p;
                    if (cur_tmp_var == bad_tmp_var) /*13:*/
#line 396 "knuth/sat10.w"
...
/*:13*/
#line 378 "knuth/sat10.w"
                    ;
/*16:*/
#line 429 "knuth/sat10.w"
...
/*:16*/
#line 380 "knuth/sat10.w"
                    ;
                    if (!non_clause)
                    {
/*17:*/
#line 444 "knuth/sat10.w"
...
/*:17*/
#line 382 "knuth/sat10.w"
                        ;
                        if (clauses && (p->stamp == clauses || p->stamp == -clauses))
/*18:*/
#line 458 "knuth/sat10.w"
...
#line 362 "knuth/sat10.w"
            ...
            if (non_clause) /*19:*/
#line 468 "knuth/sat10.w"

            {
                while (k)
                {
/*20:*/
#line 479 "knuth/sat10.w"
...
/*:19*/
#line 368 "knuth/sat10.w"
            ;
            cells += k;

/*:11*/
#line 341 "knuth/sat10.w"
            ;
/*19:*/
#line 468 "knuth/sat10.w"
...
/*:9*/
#line 90 "knuth/sat10.w"
    ;
    if (verbose & show_basics)
/*22:*/
#line 497 "knuth/sat10.w"
...
/*:22*/
#line 92 "knuth/sat10.w"
    ;
/*33:*/
#line 696 "knuth/sat10.w"

/*34:*/
#line 704 "knuth/sat10.w"
...
/*:34*/
#line 697 "knuth/sat10.w"
    ;
/*35:*/
#line 737 "knuth/sat10.w"
...
/*:36*/
#line 744 "knuth/sat10.w"
        ;
        l = mem[k];
        if (l & 1)
            ooo, p = vmem[l >> 1].wlist1, cmem[c].wlink = p, vmem[l >> 1].wlist1 = c;
        else
            ooo, p = vmem[l >> 1].wlist0, cmem[c].wlink = p, vmem[l >> 1].wlist0 = c;
    }
    if (j != cells)
    {
...
/*:35*/
#line 699 "knuth/sat10.w"
    ;
/*37:*/
#line 771 "knuth/sat10.w"

    for (c = vars; c; c--)
    {
/*21:*/
#line 488 "knuth/sat10.w"
...
/*:21*/
#line 773 "knuth/sat10.w"
        ;
        o, vmem[c].name.lng = cur_tmp_var->name.lng;
    }

/*:37*/
#line 700 "knuth/sat10.w"
    ;
/*38:*/
#line 780 "knuth/sat10.w"
...
/*:38*/
#line 701 "knuth/sat10.w"
    ;
    if (out_file) /*39:*/
#line 790 "knuth/sat10.w"
...
/*:39*/
#line 702 "knuth/sat10.w"
    ;

/*:33*/
#line 93 "knuth/sat10.w"
    ;
    imems = mems, mems = 0;
/*40:*/
#line 814 "knuth/sat10.w"

    o, level = 0, smem[0].move = 0;
/*41:*/
#line 836 "knuth/sat10.w"
    ...
    if (active)
        o, vmem[active].next = j;

/*:41*/
#line 816 "knuth/sat10.w"
    ;
choose:
    if (sanity_checking)
        sanity();
...
/*:43*/
#line 873 "knuth/sat10.w"
    ;
/*44:*/
#line 914 "knuth/sat10.w"
...
/*:42*/
#line 824 "knuth/sat10.w"
    ;
branch:
    o, nextmove = (vmem[v].wlist0 == 0 || vmem[v].wlist1 != 0);
    nodes++;
forcedmove:
    level++;
    ...
    if (active == v)
        ...
        oo, h = vmem[v].next, vmem[active].next = h;
makemove: /*45:*/
#line 927 "knuth/sat10.w"
...
#line 979 "knuth/sat10.w"
        ...
        {
            if (active == 0)
                o, active = h = l >> 1, vmem[active].next = h;
            else
                oo, vmem[l >> 1].next = h, h = l >> 1, vmem[active].next = h;
        }
        if (l & 1)
            oo, cmem[c].wlink = q, vmem[l >> 1].wlist1 = c;
        else
            oo, cmem[c].wlink = p, vmem[l >> 1].wlist0 = c;

/*:47*/
#line 970 "knuth/sat10.w"
        ;
    }

/*:46*/
#line 955 "knuth/sat10.w"
    ;

/*:45*/
#line 832 "knuth/sat10.w"
    ;
    goto choose;
backup: /*48:*/
#line 994 "knuth/sat10.w"
...
#line 1016 "knuth/sat10.w"
        ...
        for (k = 1; k <= level; k++)
        {
            ...
            printf(" " O "s" O ".8s", l & 1 ? "~" : "", vmem[l >> 1].name.ch8);
            if (out_file)
                fprintf(out_file, " " O "s" O ".8s", l & 1 ? "" : "~", vmem[l >> 1].name.ch8);
        }
        printf("\n");
        if (level < vars)
        {
            ...
            for (v = 1; v <= vars; v++)
                ...
                {
                    if (verbose & show_unused_vars)
                        printf(" " O ".8s", vmem[v].name.ch8);
                    if (out_file)
                        fprintf(out_file, " " O ".8s", vmem[v].name.ch8);
                }
            if (verbose & show_unused_vars)
                printf(")\n");
        }
...
/*:49*/
#line 1013 "knuth/sat10.w"
        ;
    }

/*:48*/
#line 834 "knuth/sat10.w"
    ;

/*:40*/
#line 95 "knuth/sat10.w"
    ;
done:
    if (verbose & show_basics)
        fprintf(stderr,
