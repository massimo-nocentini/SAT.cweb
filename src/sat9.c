...
/*:24*/
#line 86 "knuth/sat9.w"
;
/*4:*/
#line 111 "knuth/sat9.w"
...
/*:54*/
#line 87 "knuth/sat9.w"
;
/*26:*/
#line 545 "knuth/sat9.w"
...
int fixlist(register int k, int b)
{
    ...
    {
        if (o, lmem[k - 1].rating < 0)
            l = k;
        else
            l = k - 1;
        printf(" %s%.8s", l & 1 ? "~" : "", nmem[l >> 1].ch8);
/*48:*/
#line 987 "knuth/sat9.w"
...
/*:48*/
#line 981 "knuth/sat9.w"
        ;
/*49:*/
#line 997 "knuth/sat9.w"
                ...
                else
                {
                    if (o, lmem[ll + 1].rating)
                    {
                        ...
                        contra:
                            ...
                            if (b >= 0)
                                fprintf(stderr, " in bucket %d!\n", b);
                            else
                                fprintf(stderr, " while propagating unit literals!\n");
                            return 0;
                        }
                    }
                    else
...
/*:50*/
#line 1005 "knuth/sat9.w"
                ;
            }
        }

/*:49*/
#line 982 "knuth/sat9.w"
        ;
    }
    return 1;
}
...
/*:47*/
#line 88 "knuth/sat9.w"
;
main(int argc, char *argv[])
{
    register uint c, g, h, i, j, k, l, p, q, r, ii, kk, ll, fcount;
/*5:*/
#line 159 "knuth/sat9.w"

    for (j = argc - 1, k = 0; j; j--)
        switch (argv[j][0])
        {
        case 'v':
            k |= (sscanf(argv[j] + 1, "%d", &verbose) - 1);
            break;
        case 'h':
            k |= (sscanf(argv[j] + 1, "%d", &hbits) - 1);
            break;
        case 'b':
            k |= (sscanf(argv[j] + 1, "%d", &buf_size) - 1);
            break;
        case 's':
            k |= (sscanf(argv[j] + 1, "%d", &random_seed) - 1);
            break;
        case 'd':
            k |= (sscanf(argv[j] + 1, "%lld", &delta) - 1);
            thresh = delta;
            break;
        case 't':
            k |= (sscanf(argv[j] + 1, "%d", &max_iter) - 1);
            break;
        case 'l':
            k |= (sscanf(argv[j] + 1, "%d", &min_iter) - 1);
            break;
        case 'c':
            k |= (sscanf(argv[j] + 1, "%d", &confidence) - 1);
            break;
        case 'p':
            k |= (sscanf(argv[j] + 1, "%lf", &damper) - 1);
            break;
        case 'e':
            k |= (sscanf(argv[j] + 1, "%lf", &threshold) - 1);
            break;
        default:
            k = 1;
        }
...
/*:5*/
#line 91 "knuth/sat9.w"
    ;
/*9:*/
#line 255 "knuth/sat9.w"
...
/*:15*/
#line 92 "knuth/sat9.w"
    ;
/*10:*/
#line 284 "knuth/sat9.w"
...
#line 321 "knuth/sat9.w"
        ...
        for (j = k = 0;;)
        {
            ...
            if (buf[j] == '~')
                ...
                i = 0;
/*12:*/
#line 346 "knuth/sat9.w"

            {
                register tmp_var *p;
                if (cur_tmp_var == bad_tmp_var) /*13:*/
#line 364 "knuth/sat9.w"
...
/*:13*/
#line 349 "knuth/sat9.w"
                ;
/*16:*/
#line 397 "knuth/sat9.w"
...
/*:16*/
#line 351 "knuth/sat9.w"
                ;
/*17:*/
#line 413 "knuth/sat9.w"
...
/*:17*/
#line 352 "knuth/sat9.w"
                ;
                if (p->stamp == clauses || p->stamp == -clauses) /*18:*/
#line 427 "knuth/sat9.w"
...
#line 332 "knuth/sat9.w"
        ...
        goto clause_done;
    empty_clause: /*19:*/
#line 437 "knuth/sat9.w"

        while (k)
        {
/*20:*/
#line 446 "knuth/sat9.w"
...
/*:19*/
#line 339 "knuth/sat9.w"
        ;
    clause_done:
        cells += k;

/*:11*/
#line 295 "knuth/sat9.w"
        ;
    }
    if ((vars >> hbits) >= 10)
    {
...
/*:10*/
#line 93 "knuth/sat9.w"
    ;
    if (verbose & show_basics)
/*22:*/
#line 464 "knuth/sat9.w"

        fprintf(stderr, "(%d variables, %d clauses, %llu literals successfully read)\n",
                vars, clauses, cells);

/*:22*/
#line 95 "knuth/sat9.w"
    ;
/*28:*/
#line 572 "knuth/sat9.w"

/*29:*/
#line 580 "knuth/sat9.w"
...
/*:29*/
#line 573 "knuth/sat9.w"
    ;
/*30:*/
#line 607 "knuth/sat9.w"

    for (l = vars + vars; l; l--)
        o, lmem[l - 1].link = 0;

/*:30*/
#line 574 "knuth/sat9.w"
    ;
/*31:*/
#line 610 "knuth/sat9.w"
...
/*:31*/
#line 576 "knuth/sat9.w"
    ;
/*33:*/
#line 646 "knuth/sat9.w"

    for (c = vars; c; c--)
    {
/*21:*/
#line 455 "knuth/sat9.w"
...
/*:21*/
#line 648 "knuth/sat9.w"
        ;
        o, nmem[c - 1].lng = cur_tmp_var->name.lng;
    }

/*:33*/
#line 577 "knuth/sat9.w"
    ;
/*34:*/
#line 655 "knuth/sat9.w"
...
/*:34*/
#line 578 "knuth/sat9.w"
    ;

/*:28*/
#line 96 "knuth/sat9.w"
    ;
    imems = mems, mems = 0;
/*35:*/
#line 667 "knuth/sat9.w"

    factor = 1.0;
/*37:*/
#line 707 "knuth/sat9.w"
...
/*:39*/
#line 672 "knuth/sat9.w"
            ;
/*40:*/
#line 784 "knuth/sat9.w"
...
/*:38*/
#line 677 "knuth/sat9.w"
        ;
/*41:*/
#line 805 "knuth/sat9.w"
...
#line 678 "knuth/sat9.w"
        ...
        if (max_diff < threshold && iter >= min_iter)
            break;
    }
/*42:*/
#line 847 "knuth/sat9.w"
    ...
    if (verbose & show_pis)
/*43:*/
#line 868 "knuth/sat9.w"

    {
        if (iter < max_iter)
            fprintf(stderr, "converged after %d iterations.\n", iter + 1);
        else
            fprintf(stderr, "no convergence (diff %g) after %d iterations.\n",
                    max_diff, max_iter);
...
/*:43*/
#line 854 "knuth/sat9.w"
    ;
    if (verbose & show_histogram)
/*44:*/
#line 889 "knuth/sat9.w"

    {
        ...
        {
            for (i = 0; i < 10; i++)
                fprintf(stderr, "%7d", hist[i][j - 1]);
            fprintf(stderr, "\n");
        }
    }

/*:44*/
#line 856 "knuth/sat9.w"
    ;
/*45:*/
#line 927 "knuth/sat9.w"

    for (k = confidence; k <= 100; k++)
        o, bucket[k] = 2;
    unit = 2;
    for (l = 0; l < vars + vars; l += 2)
    {
        ...
        o, lmem[l].rating = acc > 0 ? +1 : acc < 0 ? -1
                                                   : 0;
        if (acc < 0)
            acc = -acc;
        j = (int)(100.0 * acc);
...
/*:45*/
#line 857 "knuth/sat9.w"
    ;
/*46:*/
#line 963 "knuth/sat9.w"
...
/*:51*/
#line 968 "knuth/sat9.w"
            ;
        }
    }

/*:46*/
#line 858 "knuth/sat9.w"
    ;
/*52:*/
#line 1059 "knuth/sat9.w"

    for (k = 100; k >= confidence; k--)
        if (ooo, fixlist(bucket[k], k) == 0)
            goto contradiction;
    while (unit & 1)
    {
        p = unit, unit = 2;
...
/*:52*/
#line 859 "knuth/sat9.w"
    ;
/*53:*/
#line 1071 "knuth/sat9.w"
...
/*:42*/
#line 688 "knuth/sat9.w"
    ;

/*:35*/
#line 98 "knuth/sat9.w"
    ;
    if (verbose & show_basics)
